...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'nhshd_photo', 'image')

        # Adding field 'Photo.image_url'
        db.add_column(u'nhshd_photo', 'image_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'nhshd_photo', 'image_url')
    ...
    models = {
        ...
        u'nhshd.patient': {
            ...
            'favourite_words': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'personal_words': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
